...
class TestBuscadorDeCursos extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        <html>
            <body>
                <span class="card-cursonome">Curso Teste 1</span>
                <span class="card-cursonome">Curso Teste 2</span>
        ...
        $httpCliente = $this->createMock(ClientInterface::class);
        $httpCliente->expects($this->once())->method('request')->with('GET', $this->url)->willReturn($response);

        $this->httpClientMock = $httpCliente;
    }
